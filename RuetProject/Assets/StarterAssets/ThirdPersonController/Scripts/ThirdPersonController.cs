...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private ThirdPersonAttackController attackscrpit;
        ...
        private void Start()
        {
            ...
            attackscrpit = GetComponent<ThirdPersonAttackController>();
#else
        ...
        private void Move()
        {
            ...
            if (!crouching && !attackscrpit.aiming)
            {
        ...
        private void weapon()
        {
            ...
            {
                _animator.runtimeAnimatorController = Shootercontroller;
